...
if (rex::isBackend() && rex::getUser()) {
    rex_view::addCssFile($addon->getAssetsUrl('media_paste_upload.css'));
    rex_view::addJSFile($addon->getAssetsUrl('media_paste_upload.js'));
