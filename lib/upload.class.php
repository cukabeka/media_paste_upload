...
class rex_media_paste_upload
{
    ...
    {
        $this->addon_name = 'media_paste_upload';
        $this->addon = rex_addon::get('media_paste_upload');
     ...
     *
     * @param bool   $sync
     * @param bool   $clear_auto
     * @param bool   $clear_after_finish
     * @param int    $simultan_uploads_value
     * @param bool   $js_debug
     * @param bool   $footnote
     * @param string $folder
     */
    ...
    public function createUploadForm()
    {
        ...
        <label for="media_paste_upload'.$this->time.'">Hier hineinkopieren (STRG+V)</label>
        
        <div id="media_paste_upload'.$this->time.'" class="'.($this->markup ? 'behave_normal' : 'styleless').'">
        
                        
        <div class="row">
        <div class="span4 target">paste here</div>
        <div class="span4 target">paste here</div>
        <div class="span4 target">paste here</div>
        </div>

        
        <noscript><p>'.rex_i18n::msg('media_paste_upload_uploadform_js_info').'</p></noscript>
        </div>';
        ...
        if ($this->markup) {
            if (!$this->clear_uploadlist_automatically) {
                ...
                $content .= '
                <p>'.
                rex_i18n::rawMsg('multiupload_uploadform_remove_label').
        ...
        $script_page_header .= '
                onSubmit: function(id,filename) {'.PHP_EOL;
        ...
        rex_extension::register('OUTPUT_FILTER', function (rex_extension_point $ep) use ($script_page_header) {
            ...
            $ersetzen = '<!-- MULTIUPLOAD_EP_REPLACE -->'.PHP_EOL.$script_page_header.'<!-- /MULTIUPLOAD_EP_REPLACE -->'.PHP_EOL.'</head>';
